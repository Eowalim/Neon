...
class level1:
    ...
    def __init__(self):
        ...
        self.txtniv = tkinter.Label(self.game, text="Niveau 1", bg="#1a1a1a", fg='white')
        ...
        # Déclaration et positionement des boutons sur la grille
        self.b1 = tkinter.Button(self.Canevas, bg='green', command=lambda: self.couleur(self.b1, "b1"))
        self.b1.grid(row=1, column=1, sticky='nesw')
        self.b2 = tkinter.Button(self.Canevas, bg='red', command=lambda: self.couleur(self.b2, "b2"))
        ...
        self.b4 = tkinter.Button(self.Canevas, bg="yellow", command=lambda: self.couleur(self.b4, "b4"))
        self.b4.grid(row=1, column=4, sticky='nesw')
        self.b5 = tkinter.Button(self.Canevas, bg='blue', command=lambda: self.couleur(self.b5, "b5"))
        self.b5.grid(row=1, column=5, sticky='nesw')
        self.b6 = tkinter.Button(self.Canevas, bg='white', command=lambda: self.couleur(self.b6, "b6"))
        ...
        self.b11 = tkinter.Button(self.Canevas, bg='blue', command=lambda: self.couleur(self.b11, "b11"))
        ...
        self.b13 = tkinter.Button(self.Canevas, bg='white', command=lambda: self.couleur(self.b13, "b13"))
        self.b13.grid(row=3, column=3, sticky='nesw')
        self.b14 = tkinter.Button(self.Canevas, bg='white', command=lambda: self.couleur(self.b14, "b14"))
        ...
        self.b17 = tkinter.Button(self.Canevas, bg='green', command=lambda: self.couleur(self.b17, "b17"))
        self.b17.grid(row=4, column=2, sticky='nesw')
        self.b18 = tkinter.Button(self.Canevas, bg='red', command=lambda: self.couleur(self.b18, "b18"))
        self.b18.grid(row=4, column=3, sticky='nesw')
        self.b19 = tkinter.Button(self.Canevas, bg='yellow', command=lambda: self.couleur(self.b19, "b19"))
        ...
        self.b24 = tkinter.Button(self.Canevas, bg='white', command=lambda: self.couleur(self.b24, "b24"))
        self.b24.grid(row=5, column=4, sticky='nesw')
        self.b25 = tkinter.Button(self.Canevas, bg='white', command=lambda: self.couleur(self.b25, "b25"))
    ...
    # Recupère la couleur du bouton cliqué dans le format ( X, X, X) et la retourne
    ...
    def check_paint(self, case1, case2, color1, color2):
        ...
        if (case1 == "b1"
            ...
            self.paint(case2,
                       color1)  # apelle de la méthode paint pour coloré la deuxieme case avec la couleur du premier bouton
    ...
    def paint(self, case, color):
        ...
        if case == "b3":
            ...
            self.b13.configure(bg=color)
            grille[2][2] = color
        elif case == "b14":
            self.b14.configure(bg=color)
            grille[2][3] = color
        elif case == "b15":
            ...
            self.b24.configure(bg=color)
            grille[4][3] = color
        elif case == "b25":
            self.b25.configure(bg=color)
            grille[4][4] = color
